...
namespace UiTestBed
{
	public static class GlobalContent
	{
		...
		public static FlatRedBall.Graphics.Animation.AnimationChainList GameContent_Slider_SliderButton { get; set; }
		public static FlatRedBall.Graphics.Animation.AnimationChainList GameContent_Slider_GridBackground { get; set; }
		...
		public static object GetStaticMember (string memberName)
		{
			switch(memberName)
			{
				...
				case  "GameContent_Slider_SliderButton":
					return GameContent_Slider_SliderButton;
				case  "GameContent_Slider_GridBackground":
					return GameContent_Slider_GridBackground;
			}
			return null;
		}
		...
		public static void Initialize ()
		{
			...
			GameContent_Slider_SliderButton = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/globalcontent/gamecontent/slider/sliderbutton.achx", ContentManagerName);
			GameContent_Slider_GridBackground = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/globalcontent/gamecontent/slider/gridbackground.achx", ContentManagerName);
						IsInitialized = true;
		}
