...
{
	public partial class SlidePuzzleGrid : PositionedObject, IDestroyable
	{
        ...
        public SlidePuzzleGrid(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("SlidePuzzleGridStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class SlidePuzzleGridExtensionMethods
	{
	}
